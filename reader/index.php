...
<body>
    <div class="container">
        ...
        <form class="form" method="post" enctype="multipart/form-data" action="upload_script2.php">
            ...
            <div class="action_form">
                <label class="custom_label"><input class="input" type="file" name="file">Select file</label>
                ...
                <label class="custom_label"><input class="submit" type="submit" name="submit">Upload</label>
            </div>
        </form>
